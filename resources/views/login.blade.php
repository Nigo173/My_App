...
<body class="flex items-center justify-center px-10 py-10">
    <section class="bg-gray-900 w-full h-full flex items-center justify-center rounded bg-opacity-5">
        <div
            class="w-80 border-2 border-slate-600 bg-white rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                <h1
                    class="text-xl font first-letter:-bold leading-tight tracking-tight text-gray-900 md:text-2xl">
                    點餐系統
                </h1>
                <form class="space-y-8 md:space-y-6" class="max-w-md mx-auto" data-action="{{ route('user_login') }}"
                    ...
                    <div>
                        <label for="account"
                            class="block mb-2 text-sm font-medium text-gray-900">帳號</label>
