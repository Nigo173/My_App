<x-layout>
    <div
        class="relative @if (!isset($member)) max-w-lg bg-slate-200 mx-auto @endif overflow-x-auto shadow-xl rounded-lg">
        <div class="px-2 py-2">
            @if (isset($member))
                {{-- 表單 --}}
                    ...
                    <div class="grid md:grid-cols-1">
                        <div class="relative z-0 w-full mb-5 group">
                            <input type="text" name="cardId" name="Id"
                                ...
                                class="text-center block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                placeholder=" " required readonly />
                            <label for="cardId"
                                class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">編號</label>
                        </div>
                    </div>
                    <div class="grid md:grid-cols-2 md:gap-6">
                        ...
                        <div class="relative z-0 w-full mb-5 group">
                            <input type="text" name="cardId"
                                ...
                                placeholder=" " required />
                            <label for="cardId"
                                class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">身分證
                    ...
                    <div class="grid md:grid-cols-2 md:gap-6">
                        ...
                        <div class="relative z-0 w-full mb-5 group">
                            ...
                            <input type="text" name="birthday"
                                ...
                                placeholder=" " required />
                            <label for="birthday"
                                class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">生日<span
                        ...
                        <div class="relative z-0 w-full mb-5 group">
                            <input type="text" name="phone"
                                ...
                                placeholder=" " required />
                            <label for="phone"
                                class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">電話</label>
                        </div>
                    </div>
                    <div class="grid md:grid-cols-2 md:gap-6">
                        {{-- 信箱 --}}
                        <div class="relative z-0 w-full mb-5 group">
                            <input type="text" name="email"
                                ...
                                placeholder=" " />
                            <label for="email"
                                class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">信箱</label>
                        </div>
                        {{-- 地址 --}}
                        <div class="relative z-0 w-full mb-5 group">
                            <input type="text" name="address"
                                ...
                                placeholder=" " />
                            <label for="address"
                                class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">地址</label>
                        </div>
                    </div>
                    {{-- 備註 --}}
                    <div class="relative z-0 w-full mb-5 group">
