            ...
            @else
                ...
                <form class="max-w-md mx-auto" action="{{ route($action) }}" method="POST" charset="UTF-8"
                    ...
                    <div class="relative h-100 h-1/4 z-0 w-full mb-8 group">
                                ...
                                <label for="myfileid" class="cursor-pointer" title="上傳圖片">
                                    ...
                                    <div class="absolute left-0 top-0 w-10 h-10">
                                        <input type="file" name="img" id="myfileid"
                                            ...
                                            class="text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                        ...
                        <label for="img"
                            class="peer-focus:font-medium absolute text-lg text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">照片
                            *圖片小於2MB*</label>
                    </div>
